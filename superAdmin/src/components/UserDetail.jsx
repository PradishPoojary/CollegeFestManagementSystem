...
const UserDetail = () => {
  ...
  if (!user) {
    return <div className="p-6 bg-gray-100 min-h-screen flex items-center justify-center">User data not available</div>;
  }

  console.log('User details:', user);

  return (
    <div className="p-6 bg-gradient-to-br from-purple-300 via-blue-300 to-green-200 min-h-screen flex flex-col items-center">
      <h1 className="text-5xl font-bold mb-8 text-gray-900">College Details</h1>
      <motion.div 
      ...
      >
        ...
        <h2 className="text-4xl font-extrabold mb-6 text-gray-900 border-b-4 pb-4 text-center border-purple-300">{user.collegeName}</h2>
